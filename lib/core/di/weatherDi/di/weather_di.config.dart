...
import '../../../../features/weather/presentation/bloc/forecast_bloc.dart'
    as _i6;
import '../../../../features/weather/presentation/bloc/predict_cubit.dart'
    as _i1001;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i407.GetPredictionUseCase>(
      () => _i407.GetPredictionUseCase(gh<_i285.WeatherRepository>()),
    );
    ...
    gh.factory<_i1001.PredictCubit>(
      () => _i1001.PredictCubit(gh<_i407.GetPredictionUseCase>()),
    );
    gh.factory<_i6.ForecastCubit>(
      () => _i6.ForecastCubit(
        gh<_i781.GetForecastWeather>(),
        gh<_i407.GetPredictionUseCase>(),
      ),
    );
